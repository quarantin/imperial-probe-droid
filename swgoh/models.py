...
class PremiumGuild(models.Model):
	...
	MESSAGE_FORMATS = {
		...
		MSG_INACTIVITY:           '> • __**${nick}**__\nHas been **inactive** for __**${last.seen}**__',
		MSG_PLAYER_NICK:          '> • __**${nick}**__\nis now known as __**${new.nick}**__',
		MSG_PLAYER_LEVEL:         '> • __**${nick}**__\nReached __*level ${level}*__',
		MSG_UNIT_UNLOCKED:        '> • __**${nick}**__\nUnlocked __*${unit}*__',
		MSG_UNIT_LEVEL:           '> • __**${nick}**__\nIncreased __*${unit}*__ to *level ${level}*',
		MSG_UNIT_RARITY:          '> • __**${nick}**__\n⭐**${unit}** promoted to __**${rarity} stars**__',
		MSG_UNIT_RELIC:           '> • __**${nick}**__\n<:relic:696704780621316196>**${unit}** __*relic ${relic}*__',
		MSG_UNIT_GEAR_LEVEL:      '> • __**${nick}**__\n__*${unit}*__\'s gear to __**level ${gear.level.roman}**__',
		MSG_UNIT_GEAR_PIECE:      '> • __**${nick}**__\nSet equipment __*${gear.piece}*__ on __**${unit}**__',
		MSG_UNIT_SKILL_UNLOCKED:  '> • __**${nick}**__\nUnlocked __**${unit}**__\'s skill __*${skill}*__',
		MSG_UNIT_SKILL_INCREASED: '> • __**${nick}**__\nIncreased skill __*${skill}*__ to tier ${tier} (__**${unit}**__)',
