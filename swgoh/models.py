...
class PremiumGuild(models.Model):
	...
	MESSAGE_FORMATS = {
		...
		MSG_INACTIVITY:           '**${nick}** has been **inactive** for __**${last.seen}**__',
		MSG_PLAYER_NICK:          '**${nick}** is now known as **${new.nick}**',
		MSG_PLAYER_LEVEL:         '**${nick}** reached __**level ${level}**__',
		MSG_UNIT_UNLOCKED:        '**${nick}** unlocked __**${unit}**__',
		MSG_UNIT_LEVEL:           '**${nick}** increased __**${unit}**__ to __**level ${level}**__',
		MSG_UNIT_RARITY:          '**${nick}** promoted __**${unit}**__ to __**${rarity} stars**__',
		MSG_UNIT_RELIC:           '**${nick}** increased __**${unit}**__ to __**relic ${relic}**__',
		MSG_UNIT_GEAR_LEVEL:      '**${nick}** increased __**${unit}**__\'s gear to __**level ${gear.level.roman}**__',
		MSG_UNIT_GEAR_PIECE:      '**${nick}** set equipment __*${gear.piece}*__ on __**${unit}**__',
		MSG_UNIT_SKILL_UNLOCKED:  '**${nick}** unlocked __**${unit}**__\'s skill __*${skill}*__',
