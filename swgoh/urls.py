...
urlpatterns = [
	...
	path('guild/tickets/global-daily/json/', views.guild_tickets_global_daily_json),
	path('guild/tickets/global-daily/', views.guild_tickets_global_daily),
	path('guild/tickets/global-per-user/json/', views.guild_tickets_global_per_user_json),
