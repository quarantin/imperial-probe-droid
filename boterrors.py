...
class BotErrors:
	...
	def error_generic(self, title, description):
		return [{
			'title': title,
			'color': 'red',
	...
	def error_no_such_command(self, command):
		return [{
	...
	def error_no_ally_code_specified(self, ctx):
		return [{
	...
	def error_no_ally_code_specified_ban(self, ctx):
		return [{
			'title': 'Error: Not Found',
			'color': 'red',
	...
	def error_ally_codes_not_registered(self, ctx, discord_ids):
	...
	def error_not_enough_ally_codes_specified(self, ally_codes, limit):
	...
	def error_too_many_ally_codes_specified(self, ally_codes, limit):
	...
	def error_no_unit_selected(self, ctx):
		return [{
	...
	def error_missing_parameter(self, ctx, command):
		return [{
	...
	def error_unknown_parameters(self, args):
	...
	def error_ally_code_not_found(self, ally_code):
		return [{
	...
	def error_ally_codes_not_found(self, ally_codes):
		return [ self.error_ally_code_not_found(ally_code)[0] for ally_code in ally_codes ]

	def error_no_mod_filter_selected(self, ctx):
		return [{
	...
	def error_register_mismatch(self, ctx, discord_ids, ally_codes):
	...
	def error_permission_denied(self):
		return [{
	...
	def error_admin_restricted(self):
		return [{
	...
	def error_no_shard_found(self, ctx):
		return [{
	...
	def error_not_a_news_channel(self, ctx):
		return [{
	...
	def error_user_banned(self, ctx):
	...
	def error_invalid_config_key(self, subcommand, ctx, config_key):
	...
	def error_invalid_config_value(self, subcommand, ctx, config_value):
